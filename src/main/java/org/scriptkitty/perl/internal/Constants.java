...
{
    public final static char AMP_C = '&';
    public final static String AMP_S = "&";

    public final static char ARRAY_C = '@';
    public final static String ARRAY_S = "@";
    ...
    public final static char HASH_C = '%';
    public final static String HASH_S = "%";
    ...
    public final static char SCALAR_C = '$';
    public final static String SCALAR_S = "$";
